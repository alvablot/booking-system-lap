    ...
    <div id="inputBox" style={{ display: {inputBox} }}>
      <form onSubmit={handleSubmit}>
        ...
        <div className="input-wrap">
          ...
          <input id="startHour" name="startHour" className="textInput"  type="text" value={inputs.startHour  || date.startHour} />
          <input id="weekNumber" name="weekNumber" className="textInput"  type="text" value={inputs.weekNumber  || date.weekNumber} />
